...
from .views.cliente import (IndexChamados as IndexClienteChamados, IndexTerminais as IndexClienteTerminais,
                            VerTerminal as ClienteVerTerminal, IndexCliente, AdicionarChamado,
                            VerChamado as ClienteVerChamado, HistoricoChamado as ClienteHistoricoChamado)
from .views.tecnico import (AtenderChamado, AtualizarDisponibilidade, EncerrarChamado, TransferirChamado,
                            IndexChamados as IndexTecnicoChamados, IndexTecnico, AtualizarLocalizacao,
                            VerChamado as TecnicoVerChamado, HistoricoChamado as TecnicoHistoricoChamado)
...
urlpatterns = [
    ...
    path('cliente/chamados/ver/<int:pk>', ClienteVerChamado.as_view(), name='cliente_ver_chamado'),
    path('cliente/chamados/historico/<int:pk>', ClienteHistoricoChamado.as_view(), name='cliente_historico_chamado'),
    path('cliente/terminais', IndexClienteTerminais.as_view(), name='index_cliente_terminal'),
    path('cliente/terminais/ver/<int:pk>', ClienteVerTerminal.as_view(), name='cliente_ver_terminal'),
    ...
    path('tecnico/chamados/ver/<int:pk>', TecnicoVerChamado.as_view(), name='tecnico_ver_chamado'),
    path('tecnico/chamados/historico/<int:pk>', TecnicoHistoricoChamado.as_view(), name='tecnico_historico_chamado'),
    ...
    path('tecnico/chamados/transferir/<int:pk>', TransferirChamado.as_view(), name='transferir_chamado'),
