...
class TestCadastramentoTerminal(TestCase):
    ...
    def test_adicionar_terminal_valido(self):
        dados = {
            'numero_serie': '123'
        }
        ...
        resultado = terminal.numero_serie
        esperado = dados['numero_serie']
        self.assertEqual(resultado, esperado)  # teste de banco de dados

    def test_adicionar_terminal_invalido(self):
        dados = {
            'numero_serie': '123',
    ...
    def test_editar_terminal_valido(self):
        dados_criacao = {
            'numero_serie': '123',
    ...
    def test_editar_terminal_invalido(self):
        dados_criacao = {
            'numero_serie': '123',
            'data_instalacao': '2022-08-05',  # o modelo usa o formato YYYY-MM-DD
            'rua': 'Praça da Sé',
    ...
    def test_remover_terminal_valido(self):
        dados = {
            'numero_serie': '123'
        }
    ...
    def test_reativar_terminal_valido(self):
        dados = {
            'numero_serie': '123',
            'is_active': False
        }
