"""
Django settings for scmma project.
...
SECRET_KEY = 'django-insecure-**^g0^is8^9h$yq(^(3_e=)y&)a6(el&qjp4r=fzl@(ijk=@ta'
...
WSGI_APPLICATION = 'scmma.wsgi.application'
